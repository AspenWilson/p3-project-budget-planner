...
def upgrade() -> None:
    ...
    op.create_table('expenses_temp',
        Column('id', Integer(), primary_key=True),
        Column('category_id', Integer(), ForeignKey('monthly_budget.id')), 
    )
    op.execute('INSERT INTO expenses_temp SELECT * FROM expenses')
    op.drop_table('expenses')
    op.rename_table('expenses_temp', 'expenses')
